...
static int exfat_mkdir(struct user_namespace *mnt_userns, struct inode *dir, struct dentry *dentry, umode_t mode)
{
	struct super_block *sb = dir->i_sb;
	struct inode *inode;
	FILE_ID_T fid;
...
static int exfat_rename(struct user_namespace *mnt_userns, struct inode *old_dir, struct dentry *old_dentry,
...
static int exfat_setattr(struct user_namespace *mnt_userns,
...
static int exfat_getattr(struct user_namespace *mnt_userns,
