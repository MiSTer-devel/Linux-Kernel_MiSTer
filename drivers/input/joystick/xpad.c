...
//	{ 0x045e, 0x0b12, "Microsoft Xbox Series S|X Controller", MAP_SHARE_BUTTON | MAP_SHARE_OFFSET, XTYPE_XBOXONE },
	...
	{ 0x2c22, 0x2303, "Qanba Obsidian Arcade Joystick", 0, XTYPE_XBOX360 },  /* Works better in XBOX360 */{ 0x2993, 0x2001, "TECNO Pocket Go", 0, XTYPE_XBOX360 },
...
static int xpad_probe(struct usb_interface *intf, const struct usb_device_id *id)
{
	...
	if(strstr(udev->product, "VADER3") || strstr(udev->product, "VADER4")) {
 ...
 */
	...
	if (xpad->mapping & MAP_VADER5) flydigi_init(xpad);
	return 0;
