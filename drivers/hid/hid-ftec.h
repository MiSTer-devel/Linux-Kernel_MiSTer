...
/* MiSTer: extern prototypes for hid-ftecff.c's cross-TU-visible entry points,
 * needed to satisfy 6.18's unconditional -Wmissing-prototypes (not present
 * as a warning in the kernel this driver originally targeted). */
