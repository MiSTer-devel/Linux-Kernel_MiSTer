...
home_led:
	 ...
	 * Registered before the home LED, whose failure paths return
	 * early and would otherwise skip this node, silently breaking
	 * Joy-Con pairing.
	 */
